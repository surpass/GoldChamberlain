以下操作以windows操作系统Git Bash为例：
    ...
    4  ls
    5
    6  ssh-keygen.exe  -t rsa -C "surpass.li@gmail.com" #生成ssh key
    7  cd /e/workspace/portlet                          #进入工作目录
    8  
    9  pwd                                              #查看当前路径
   10  
   11  git config --global user.name "surpass.li"       #配置git用户名  
   12
   13  git config --global user.email surpass.li@gmail.com  #配置git邮件  
   14  
   15  git init                             #初使化工作目录
   16  
   ...
   21  git remote add origin git@github.com:surpass/GoldChamberlain.git     #将本地版本分支添加到远程版本库
